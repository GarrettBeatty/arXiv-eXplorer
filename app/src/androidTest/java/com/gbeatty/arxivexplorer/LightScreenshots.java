...
public class LightScreenshots {
    ...
    public void takeMainScreenshots() {
        ...
        preferencesEditor.putBoolean("show_abstract", false);
...
//        onView(withId(R.id.navigation_browse)).perform(click());
        Screengrab.screenshot("light_browse");
...
//        onView(withId(R.id.navigation_dashboard)).perform(click());
        ...
        Screengrab.screenshot("light_dashboard");

        onView(withId(R.id.papers_recycler_view))
                .perform(RecyclerViewActions.actionOnItemAtPosition(1, click()));

        Screengrab.screenshot("light_details");
        ...
        Screengrab.screenshot("light_pdf");
...
//        onView(withId(R.id.navigation_downloaded)).perform(click());
        ...
        Screengrab.screenshot("light_downloaded");
